var Swiper = function (f, b) {
    ...
    function v(c) {
        if (a.isTouched && !b.onlyExternal && !(u && "mousemove" == c.type)) {
            if (b.swiperNo) {
                if (a.activeSlide == 0 && a.touches.current > a.touches.start)
                    return;
                if (a.activeSlide == (a.slides.length - 1) && a.touches.current < a.touches.start)
                    return;
            }
    ...
    if (f.nodeType || document.querySelectorAll && 0 != document.querySelectorAll(f).length) {
        ...
        h = "horizontal" == b.mode;
        a.touchEvents = {
            touchStart: a.support.touch || !b.simulateTouch ? "touchstart" : a.ie10 ? "MSPointerDown" : "touchstart",
            touchMove: a.support.touch || !b.simulateTouch ? "touchmove" : a.ie10 ? "MSPointerMove" : "mousemove",
            touchEnd: a.support.touch || !b.simulateTouch ? "touchend" : a.ie10 ? "MSPointerUp" : "touchend"
        };
        ...
        a.ie10 ? (n.addEventListener(a.touchEvents.touchStart, s, !1), document.addEventListener(a.touchEvents.touchMove, v, !1), document.addEventListener(a.touchEvents.touchEnd, r, !1)) : (a.support.touch && (n.addEventListener("touchstart", s, !1), n.addEventListener("touchmove", v, !1), n.addEventListener("touchend", r, !1)), b.simulateTouch && (n.addEventListener("touchstart", s, !1), document.addEventListener("mousemove", v, !1), document.addEventListener("touchend", r, !1)));
        a.destroy = function (c) {
            (!1 === c ? c : 1) && window.removeEventListener(a.resizeEvent, a.resizeFix, !1);
            a.ie10 ? (n.removeEventListener(a.touchEvents.touchStart, s, !1), document.removeEventListener(a.touchEvents.touchMove, v, !1), document.removeEventListener(a.touchEvents.touchEnd, r, !1)) : (a.support.touch && (n.removeEventListener("touchstart", s, !1), n.removeEventListener("touchmove", v, !1), n.removeEventListener("touchend", r, !1)), n.removeEventListener("touchstart", s, !1), document.removeEventListener("mousemove", v, !1), document.removeEventListener("touchend", r, !1));
        ...
        a.swipeNext = function (c) {
            !c && b.loop && a.fixLoop(); !c && b.autoPlay && a.stopAutoPlay();
